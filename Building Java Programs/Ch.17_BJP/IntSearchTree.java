// This class stores in values in a binary search tree. Duplicates are allowed. Each node
// of the tree has the binary search tree property.
...
public class IntSearchTree {
    ...
    // post: value is added to overall tree so as to preserve the binary search search
    // tree property
    public void add(int value) {
        overallRoot = add(overallRoot, value);
    }

    // post: value is added to given tree so as to preserve the binary search tree property
    ...
    // post: prints contents of the tree with given root using inorder traversal
