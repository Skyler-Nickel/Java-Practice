// Example provided in the textbook chapter 10
...
public class TallyVotes2 {
    ...
    // ballots. Candidate names are listed in order of preference with tabs separating
    // choices.
    ...
    // Performs one round of ranked choice voting. The candidate with the lowest vote
    // total is eliminated until some candidate gets majority or until we reach a tie
    // between only two candidates. Assumes the list is in order by candidate name.
    ...
    // Counts and reports the votes for the next candidate starting at the given
    // index in the ballots list.
    ...
    // Eliminate the given candidate from all ballots.
